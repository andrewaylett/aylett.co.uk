...
describe('ArticleEntry', () => {
  ...
  it('renders article title and author when metadata is resolved', async () => {
    ...
    await act(async () =>
      render(<ListingEntry data={data} name="example-article" />),
    );
  ...
  it('renders "Draft" label for draft articles', async () => {
    ...
    await act(async () =>
      render(<ListingEntry data={data} name="draft-article" />),
    );
  ...
  it('renders revision and revised date correctly', async () => {
    ...
    await act(async () =>
      render(<ListingEntry data={data} name="revised-article" />),
    );
  ...
  it('renders abstract when provided', async () => {
    ...
    await act(async () =>
      render(<ListingEntry data={data} name="abstract-article" />),
    );
  ...
  it('handles missing metadata gracefully', async () => {
    ...
    await act(async () =>
      render(<ListingEntry data={data} name="empty-article" />),
    );
