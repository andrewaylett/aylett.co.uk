...
export function PuzzleView({
  ...
  return (
    <div className="flex gap-5 flex-wrap items-start mb-2">
      {/* Board + input */}
      <div className="flex-[1_1_340px] max-w-105">
        <svg
          viewBox="0 0 379 379"
        ...
        <div className="flex gap-2 mt-3.5">
          <input
            ...
            autoFocus
            className={[
              'flex-1 px-3.5 py-2.5 text-[1.05rem] tracking-widest uppercase',
      ...
      {/* Found words */}
      <div className="flex-[1_1_220px] bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-4 min-h-50">
